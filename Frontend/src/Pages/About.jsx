    ...
    <div id="about" className="page overflow-hidden">
      ...
      >
        <div className="container mx-auto px-5 sm:px-6 lg:px-10 max-w-6xl">
          <motion.h1
            className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 text-gray-900 leading-tight"
            variants={fadeInUp}
          >
            About{" "}
      ...
      {/* ===== About Section ===== */}
      <motion.section
        className="py-20 md:py-28 bg-base-200 text-base-content"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        variants={fadeInUp}
      >
        <div className="container mx-auto px-5 sm:px-6 lg:px-10 max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
            ...
            {/* Text Section */}
            <motion.div
              className="flex-1 space-y-6 text-base sm:text-lg leading-relaxed"
              variants={fadeInUp}
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        variants={fadeInUp}
        className="px-5 sm:px-6 lg:px-10"
      >
        <TeamSection />
      </motion.div>
      ...
      >
        <div className="container mx-auto px-5 sm:px-6 lg:px-10 max-w-7xl text-center">
          ...
          >
            {/* Mission */}
            <motion.div
              className="card bg-base-100 border border-base-300 shadow-lg p-8 rounded-2xl"
              variants={fadeInUp}
            >
