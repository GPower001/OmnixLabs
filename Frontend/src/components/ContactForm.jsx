...
//         <div className="bg-base-100 rounded-xl p-8 border border-gray-200 shadow-sm">
...
//                 className="w-full border border-gray-300 rounded-md px-4 py-3 bg-base-100 focus:ring-2 focus:ring-indigo-500 outline-none"
//               />
//             </div>
...
//                 className="w-full border border-gray-300 rounded-md px-4 py-3 bg-base-100 resize-none focus:ring-2 focus:ring-indigo-500 outline-none"
//               ></textarea>
//             </div>
          ...
          <div className="space-y-6">
            ...
            <div className="border border-base-300 rounded-xl p-6 shadow-sm bg-base-200 flex items-start gap-4 hover:shadow-md transition-shadow">
              ...
              <div>
                ...
                <p className="text-base-content/70 text-sm">hello@omnimxlabs.com</p>
              </div>
            </div>
            ...
            <div className="border border-base-300 rounded-xl p-6 shadow-sm bg-base-200 flex items-start gap-4 hover:shadow-md transition-shadow">
              ...
              <div>
                ...
                <p className="text-base-content/70 text-sm">+1 (555) 123-4567</p>
              </div>
            </div>
            ...
            <div className="border border-base-300 rounded-xl p-6 shadow-sm bg-base-200 flex items-start gap-4 hover:shadow-md transition-shadow">
              ...
              <div>
                ...
                <p className="text-base-content/70 text-sm">123 Innovation Drive, Tech City, TC 12345</p>
              </div>
            </div>
