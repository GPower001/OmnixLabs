...
const CreativeMediaSection = () => {
  return (
    <section className="bg-base-100 py-20 px-6 relative overflow-hidden">
      {/* Header */}
      <div className="relative text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-extrabold mb-3 tracking-tight text-base-content">
          Creative Media
        </h2>
