...
const WhyChoose = () => {
  return (
    <section className="py-16 px-4 sm:px-6 md:px-10 bg-gray-50 font-montserrat">
      <motion.div
        initial={{ opacity: 0, y: -30 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 justify-center">
        {cardsData.map((card, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            whileHover="hover"
            className="group w-full sm:w-80 min-h-[320px] bg-white p-6 sm:p-8 rounded-xl shadow-lg flex flex-col items-center text-center cursor-pointer mx-auto"
          >
            <motion.div
              variants={{
                hover: { rotate: [0, -10, 10, 0], scale: 1.2 },
