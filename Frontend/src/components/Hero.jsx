      ...
      <div className="hero-content text-center text-neutral-content flex flex-col gap-10 mt-10 md:mt-20 px-4 md:px-10">
        ...
        >
          ...
          >
            <button 
              onClick={handleStartProject}
              className="group flex items-center justify-center gap-2 px-6 py-3 rounded-lg text-white font-semibold bg-gradient-to-r from-blue-700 to-cyan-400 hover:opacity-90 transition max-w-[200px] w-full mx-auto sm:max-w-[200px]"
            >
              Start Your Project{" "}
              <ArrowRight
                size={18}
            ...
            >
              ...
              <span className="absolute inset-0 bg-gradient-to-r from-blue-700 to-cyan-400 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-out"></span>
            </button>
          </motion.div>
        </motion.div>
