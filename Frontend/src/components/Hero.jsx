...
//           {/* Buttons */}
//           <motion.div
//             className="flex flex-col sm:flex-row justify-center mt-6 sm:mt-10 gap-4 sm:gap-2"
//             initial={{ opacity: 0, y: 30 }}
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ duration: 1, delay: 0.6 }}
//           >
//             <button className="group flex items-center justify-center gap-2 px-6 py-3 rounded-lg text-white font-semibold bg-gradient-to-r from-blue-500 to-purple-500 hover:opacity-90 transition max-w-[200px] w-full mx-auto sm:max-w-none">
//               Start Your Project{" "}
//               <ArrowRight
//                 size={18}
...
//             <button className="relative overflow-hidden px-6 py-3 rounded-lg font-bold text-white bg-black group mt-2 sm:mt-0 max-w-[200px] w-full mx-auto sm:max-w-none">
...
//               className="group flex items-center justify-center gap-2 px-6 py-3 rounded-lg text-white font-semibold bg-gradient-to-r from-blue-500 to-purple-500 hover:opacity-90 transition max-w-[200px] w-full mx-auto sm:max-w-none"
//             >
//               Start Your Project{" "}
//               <ArrowRight
//                 size={18}
...
//               className="relative overflow-hidden px-6 py-3 rounded-lg font-bold text-white bg-black group mt-2 sm:mt-0 max-w-[200px] w-full mx-auto sm:max-w-none"
//             >
//               <span className="relative z-10 transition-colors duration-500 group-hover:text-white">
//                 View Our Work
//               </span>
